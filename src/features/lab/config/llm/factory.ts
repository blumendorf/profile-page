 ...
 */
export const MODEL_STORAGE_KEY = 'lab-config-selected-model';
...
/**
 * Legacy: Create a default engine singleton for backward compatibility
 * Used by config-generator.ts (legacy)
 */
