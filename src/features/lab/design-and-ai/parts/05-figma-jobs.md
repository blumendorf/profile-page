...
Marketing sites move into the codebase when there's engineering bandwidth, and otherwise live in [Webflow](https://webflow.com/), [Framer](https://www.framer.com/), [Canva](https://www.canva.com/), or [Notion](https://www.notion.so/). Brand and illustration work moves to [Adobe](https://www.adobe.com/creativecloud.html), [Affinity](https://affinity.serif.com/), [Procreate](https://procreate.com/), or whatever the brand designer prefers. Pitch decks live in Keynote, [Pitch](https://pitch.com/), or now [Claude Design](https://www.anthropic.com/news/claude-design-anthropic-labs). None of this work was the source-of-truth problem. It was just adjacent work that happened to share a tool with the design system.
...
**Exploration of a flow that doesn't exist yet.** Paper, a tablet, or a lightweight whiteboarding tool: [Excalidraw](https://excalidraw.com/), [tldraw](https://www.tldraw.com/), [FigJam](https://www.figma.com/figjam/), [Miro](https://miro.com/). These are *better* than Figma for this mode because they don't tempt you into pixel-pushing while you're still trying to think. Pencil sketches are provisional by default; the line weight varies with hand pressure, which carries information about confidence. Pen commits, pencil proposes.

**Documentation of a flow that exists today.** This goes in the repo. A markdown file per flow, with embedded screenshots auto-generated from [Playwright](https://playwright.dev/) or [Storybook](https://storybook.js.org/) snapshots, plus a [Mermaid](https://mermaid.js.org/) diagram for state transitions. The screenshots stay current because CI regenerates them on every build. More accurate than Figma ever was, because Figma always lagged production.
...
**Communication of a flow to stakeholders.** A preview URL plus a short [Loom](https://www.loom.com/) walking through it. Or the journey route shared as a link. Both higher fidelity than Figma, neither requiring an install.
...
That's the honest gap. Whether canvas-as-code tools ([Paper](https://paper.design/), [Pencil](https://www.pencil.dev/); see the [tools survey](../tools/)) close it depends on whether their canvas affordances live up to a real Figma-replacement test for the exploration job. Both products are young enough that the answer isn't obvious. I'm running the experiment.
