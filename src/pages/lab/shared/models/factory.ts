import type { LLMEngine } from "./engine-interface";
import { getModelConfig, DEFAULT_MODEL_ID } from "./config";
 ...
 * @param modelId - Model ID from the config (e.g., 'smollm-360m', 'mistral-3b')
 */
 ...
 */
export const MODEL_STORAGE_KEY = 'lab-selected-model';
